...
myHolder.pTitle.setText(comment);
      ...
      //  String pId = extras.getString("postId");
        ...
        myHolder.deleteCommentIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  alertDialogBilder.setTitle("Log out");
                alertDialogBilder.setMessage("Are you sure you want to delete comment?")
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int id) {
                                Query query= FirebaseDatabase.getInstance().getReference("Posts").child(postId).child("Comment").child(cId);
