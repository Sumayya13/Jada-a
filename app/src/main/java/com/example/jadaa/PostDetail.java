...
// not added
    ...
    private void updadteCommentCount() {

        //mProsessComments =false;
        final FirebaseDatabase database = FirebaseDatabase.getInstance();
        final DatabaseReference ref = database.getReference("Posts").child(postId);
...
/*
                ...
                ref.child("CommentCounter").setValue(""+newCommentBal);
